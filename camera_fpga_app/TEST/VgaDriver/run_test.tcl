...
foreach order [lsort [array names tb_src_files]] {
    vlog -work work -sv -svfilesuffix=sv,svt -O0 -stats=all $uut_src_loc/$tb_src_files($order)
} 

# initialise simulation
echo "Simulation loading:"
vsim -c -t ps -classdebug -gconrun -onfinish final work.$tb_module
