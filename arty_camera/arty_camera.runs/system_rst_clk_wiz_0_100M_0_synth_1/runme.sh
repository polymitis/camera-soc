...
HD_PWD='C:/Users/pfountas/Documents/Projects/pfountas-research/arty_camera/arty_camera.runs/system_rst_clk_wiz_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_rst_clk_wiz_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_rst_clk_wiz_0_100M_0.tcl
