...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set max3421e_gpx [ create_bd_port -dir I -type data max3421e_gpx ]
  set max3421e_int [ create_bd_port -dir I -type intr max3421e_int ]
  set_property -dict [ list \
CONFIG.SENSITIVITY {LEVEL_LOW} \
 ] $max3421e_int
  set max3421e_miso [ create_bd_port -dir I -type data max3421e_miso ]
  set max3421e_mosi [ create_bd_port -dir O -type data max3421e_mosi ]
  set max3421e_res [ create_bd_port -dir O -type rst max3421e_res ]
  set max3421e_sclk [ create_bd_port -dir O -type clk max3421e_sclk ]
  set max3421e_ss [ create_bd_port -dir O -from 0 -to 0 max3421e_ss ]
...
CONFIG.USE_BOARD_FLOW {true} \
  ...
  set_property -dict [ list \
CONFIG.CLKOUT1_JITTER {436.214} \
CONFIG.CLKOUT1_PHASE_ERROR {478.666} \
CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {166.000} \
CONFIG.CLKOUT2_JITTER {423.923} \
CONFIG.CLKOUT2_PHASE_ERROR {478.666} \
CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {200.000} \
CONFIG.CLKOUT2_USED {true} \
CONFIG.CLKOUT3_JITTER {470.797} \
CONFIG.CLKOUT3_PHASE_ERROR {478.666} \
...
CONFIG.USE_BOARD_FLOW {true} \
  ...
  # Create instance: xlconcat_int_0, and set properties
  set xlconcat_int_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 xlconcat_int_0 ]
  ...
  connect_bd_net -net axi_quad_spi_0_io0_o [get_bd_ports max3421e_mosi] [get_bd_pins axi_quad_spi_0/io0_o]
  connect_bd_net -net axi_quad_spi_0_ip2intc_irpt [get_bd_pins axi_quad_spi_0/ip2intc_irpt] [get_bd_pins xlconcat_int_0/In0]
  connect_bd_net -net axi_quad_spi_0_sck_o [get_bd_ports max3421e_sclk] [get_bd_pins axi_quad_spi_0/sck_o]
  connect_bd_net -net axi_quad_spi_0_ss_o [get_bd_ports max3421e_ss] [get_bd_pins axi_quad_spi_0/ss_o]
  ...
  connect_bd_net -net clk_wiz_0_clk_out3 [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins clk_wiz_0/clk_out3]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins rst_clk_wiz_0_100M/dcm_locked]
  connect_bd_net -net max3421e_gpx_1 [get_bd_ports max3421e_gpx] [get_bd_pins axi_gpio_0/gpio_io_i]
  connect_bd_net -net max3421e_int_1 [get_bd_ports max3421e_int] [get_bd_pins xlconcat_int_0/In1]
  connect_bd_net -net max3421e_miso_1 [get_bd_ports max3421e_miso] [get_bd_pins axi_quad_spi_0/io1_i]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_quad_spi_0/s_axi4_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins rst_clk_wiz_0_100M/slowest_sync_clk] [get_bd_pins rst_mig_7series_0_83M/slowest_sync_clk]
  ...
  connect_bd_net -net reset_1 [get_bd_ports max3421e_res] [get_bd_ports reset] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins mig_7series_0/sys_rst] [get_bd_pins rst_clk_wiz_0_100M/ext_reset_in]
  connect_bd_net -net rst_clk_wiz_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_quad_spi_0/s_axi4_aresetn] [get_bd_pins rst_clk_wiz_0_100M/peripheral_aresetn]
...
#  -string -flagsOSRD
preplace port max3421e_sclk -pg 1 -y 1090 -defaultsOSRD
preplace port ddr3_sdram -pg 1 -y 590 -defaultsOSRD
preplace port max3421e_mosi -pg 1 -y 970 -defaultsOSRD
preplace port sys_clock -pg 1 -y 1030 -defaultsOSRD
preplace port max3421e_miso -pg 1 -y 1010 -defaultsOSRD -right
preplace port usb_uart -pg 1 -y 450 -defaultsOSRD
preplace port max3421e_res -pg 1 -y 240 -defaultsOSRD
preplace port max3421e_gpx -pg 1 -y 320 -defaultsOSRD -right
preplace port max3421e_int -pg 1 -y 870 -defaultsOSRD -right
preplace port reset -pg 1 -y 890 -defaultsOSRD
preplace portBus max3421e_ss -pg 1 -y 1150 -defaultsOSRD
preplace inst rst_mig_7series_0_83M -pg 1 -lvl 1 -y 580 -defaultsOSRD
preplace inst rst_clk_wiz_0_100M -pg 1 -lvl 3 -y 910 -defaultsOSRD
preplace inst xlconcat_int_0 -pg 1 -lvl 3 -y 1120 -defaultsOSRD
preplace inst axi_intc_0 -pg 1 -lvl 4 -y 780 -defaultsOSRD
preplace inst mig_7series_0 -pg 1 -lvl 4 -y 630 -defaultsOSRD
preplace inst microblaze_0_axi_periph -pg 1 -lvl 3 -y 630 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 4 -y 330 -defaultsOSRD
preplace inst mdm_1 -pg 1 -lvl 1 -y 400 -defaultsOSRD
preplace inst axi_uartlite_0 -pg 1 -lvl 4 -y 460 -defaultsOSRD
preplace inst microblaze_0 -pg 1 -lvl 2 -y 370 -defaultsOSRD
preplace inst clk_wiz_0 -pg 1 -lvl 2 -y 1020 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 3 -y 140 -defaultsOSRD
preplace inst microblaze_0_local_memory -pg 1 -lvl 3 -y 360 -defaultsOSRD
preplace inst axi_quad_spi_0 -pg 1 -lvl 4 -y 1060 -defaultsOSRD
preplace netloc mig_7series_0_mmcm_locked 1 0 5 30 480 NJ 480 980J 450 1380J 530 1740
preplace netloc max3421e_gpx_1 1 4 1 NJ
preplace netloc clk_wiz_0_locked 1 2 1 910
preplace netloc mig_7series_0_DDR3 1 4 1 NJ
preplace netloc axi_quad_spi_0_ss_o 1 4 1 NJ
preplace netloc microblaze_0_Clk 1 0 5 40 90 380 90 940 1020 1410 540 1720
preplace netloc microblaze_0_axi_periph_M03_AXI 1 3 1 1350
preplace netloc rst_mig_7series_0_83M_peripheral_aresetn 1 1 3 NJ 620 990 810 1370
preplace netloc microblaze_0_axi_periph_M00_AXI 1 3 1 1360
preplace netloc microblaze_0_M_AXI_DP 1 2 1 920
preplace netloc axi_mem_intercon_M00_AXI 1 3 1 1390
preplace netloc microblaze_0_M_AXI_DC 1 2 1 910
preplace netloc microblaze_0_ilmb_1 1 2 1 N
preplace netloc max3421e_miso_1 1 4 1 NJ
preplace netloc sys_clock_1 1 0 2 NJ 1030 NJ
preplace netloc axi_quad_spi_0_io0_o 1 4 1 NJ
preplace netloc rst_mig_7series_0_83M_mb_reset 1 1 1 370
preplace netloc xlconcat_0_dout 1 3 1 1440
preplace netloc axi_quad_spi_0_sck_o 1 4 1 NJ
preplace netloc microblaze_0_axi_periph_M01_AXI 1 3 1 1390
preplace netloc microblaze_0_M_AXI_IC 1 2 1 930
preplace netloc max3421e_int_1 1 2 3 980 1060 1450J 870 NJ
preplace netloc clk_wiz_0_clk_out1 1 2 2 920J 1010 1400
preplace netloc axi_uartlite_0_UART 1 4 1 NJ
preplace netloc clk_wiz_0_clk_out2 1 2 2 NJ 1030 1360
preplace netloc mig_7series_0_ui_clk_sync_rst 1 0 5 50 490 NJ 490 970J 440 1330J 250 1730
preplace netloc microblaze_0_axi_periph_M02_AXI 1 3 1 1380
preplace netloc microblaze_0_dlmb_1 1 2 1 N
preplace netloc clk_wiz_0_clk_out3 1 2 2 N 1050 NJ
preplace netloc microblaze_0_debug 1 1 1 N
preplace netloc axi_quad_spi_0_ip2intc_irpt 1 2 3 930 1040 1460J 880 1720
preplace netloc axi_intc_0_irq 1 1 4 390 930 930J 1000 1430J 860 1720
preplace netloc rst_clk_wiz_0_100M_peripheral_aresetn 1 3 1 1420
preplace netloc reset_1 1 0 5 NJ 890 380 890 980 820 1340 230 1740J
preplace netloc rst_mig_7series_0_83M_interconnect_aresetn 1 1 2 NJ 600 950
preplace netloc mdm_1_debug_sys_rst 1 0 2 20 340 370
preplace netloc rst_mig_7series_0_83M_bus_struct_reset 1 1 2 NJ 560 960
levelinfo -pg 1 0 210 650 1170 1590 1760 -top 0 -bot 1240
",
}
